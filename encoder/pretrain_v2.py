...
class P0Model(nn.Module):
 def __init__(self,encoder,active_heads,marker_count=1200):
  super().__init__();self.encoder=encoder;self.decoders=nn.ModuleDict()
 ...
 def loss(self,x,targets):
  ...
  total=sum(parts.values());return total,{**parts,'total':total}
